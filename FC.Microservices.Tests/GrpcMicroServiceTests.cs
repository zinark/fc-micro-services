...
namespace FCMicroservices.Tests
{
    ...
    public class GrpcMicroServiceTests
    {
        ...
        public void QueryTest()
        {
            ...
            Reply reply = grpc.Query(filter, null).Result;
            ...
            GetFirstReply sumReply = reply.Json.ParseJson<GetFirstReply>();
        ...
        public void ExecuteTest()
        {
            ...
            Reply reply = grpc.Execute(cmd, null).Result;

            Console.WriteLine(reply.ToJson(true));
            Console.WriteLine(reply.Error);
            Assert.IsTrue(reply.Success);
            Assert.AreEqual("Ticimax.Hello.Microservice.MicroMessages.Commands.SumReply", reply.Type);
            SumReply sumReply = reply.Json.ParseJson<SumReply>();
        ...
        {
            var grpc = MakeGrpc();
            MicroMessageContracts contracts = grpc.Contracts(new None(), null).Result;
